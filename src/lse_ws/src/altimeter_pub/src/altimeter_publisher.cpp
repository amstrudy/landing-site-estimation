...
#include <altimeter_pub/yocto_msg.h>
...
int main (int argc, char *argv[])
{
	...
	ros::Publisher raw_pub = n.advertise<altimeter_pub::yocto_msg>("/yocto/raw", 1000);
    ...
    while(ros::ok())
	{
		...
		altimeter_pub::yocto_msg raw_msg; // how to import custom message??
